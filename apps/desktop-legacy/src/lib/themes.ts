...
export type termshTheme = {
  id: ThemeId;
  label: string;
  /** Tema seçicide önizleme rengi */
  swatch: string;
  xterm: ITheme;
};
...
export const THEMES: termshTheme[] = [
  { id: "rego", label: "termsh", swatch: "#001d49", xterm: regoXterm },
  { id: "aurora", label: "Aurora", swatch: "#88c0d0", xterm: auroraXterm },
  { id: "ember", label: "Ember", swatch: "#fabd2f", xterm: emberXterm },
  { id: "obsidian", label: "Obsidian", swatch: "#cba6f7", xterm: obsidianXterm },
  { id: "forest", label: "Forest", swatch: "#a7c080", xterm: forestXterm },
  { id: "light", label: "Light", swatch: "#f5f5f7", xterm: lightXterm },
];

export const DEFAULT_THEME_ID: ThemeId = "rego";
...
export function getTheme(id: ThemeId): termshTheme {
