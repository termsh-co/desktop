...
const PATHS: Record<IconName, ReactNode> = {
  ...
  <>
    ...
    <path d="M9.9 5.1A10.8 10.8 0 0112 5c6.5 0 10 7 10 7a18.2 18.2 0 01-4.9 5.9" />
    <path d="M6.1 6.1A18.5 18.5 0 002 12s3.5 7 10 7a10.4 10.4 0 004.1-.8" />
  </>
  ),
  edit: (
  <>
  ...
  cloud_off: (
  <>
    <path d="M7 18h11a4 4 0 100-8 5.5 5.5 0 00-10.9-1.5A3.5 3.5 0 007 18z" />
    <path d="M3 3l18 18" />
  </>
  ),
  bell: (
  ...
  <>
    ...
    <path d="M8 11c0-3.3 2.7-6 6-6" />
    <path d="M6 11c0-4.4 3.6-8 8-8" />
    <path d="M4 11c0-5.5 4.5-10 10-10" />
    <path d="M12 15v2" />
    <path d="M10 17c0 2.2 1.8 4 4 4" />
    <path d="M8 19c0 3.3 2.7 6 6 6" />
  </>
  ),
  face: (
  <>
    ...
    <path d="M9 15c1 1.5 2.5 2 3 2s2-.5 3-2" />
  </>
  ),
};
...
export function Icon({ name, className = "", size = 18 }: Props) {
  return (
    <svg
      className={`termsh-icon ${className}`.trim()}
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill="none"
